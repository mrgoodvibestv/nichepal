        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-semibold text-black">Generate Report</h2>
              <button
                onClick={closeModal}
                className="p-2 -mr-2 rounded-lg hover:bg-gray-100 transition text-gray-400 hover:text-gray-600"
                aria-label="Close"
              >
